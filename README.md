...
> NOTE: on Linux you'll need to install the OpenGL, X11 and ALSA development packages (e.g. mesa-common-dev, libx11-dev, libxi-dev, libxcursor-dev and libasound2-dev).
